...
public class RegisterActivityTest {
    ...
    public void click_Sign_Up_Button_Shows_MainActivity(){
        ...
        onView(withId(R.id.register_form_name)).perform(clearText(), typeText("meme"));
        onView(withId(R.id.register_form_email)).perform(clearText(), typeText("MeMeTestUser_" + new Random().nextInt(9999) + "@gmail.com"));
