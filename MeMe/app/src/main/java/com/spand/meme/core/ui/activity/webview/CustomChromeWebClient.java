...
public class CustomChromeWebClient extends WebChromeClient
     ...
     */
    @SuppressWarnings("unused")
    public CustomChromeWebClient(View activityNonVideoView, ViewGroup activityVideoView) {
     ...
     */
    @SuppressWarnings("unused")
    public CustomChromeWebClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView) {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
     ...
     */
    @SuppressWarnings("unused")
    public CustomChromeWebClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView, CustomWebView webView) {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
        this.loadingView = loadingView;
