...
package com.spand.meme.skype.core.participants.info;
...
public interface Contact {
    ...
    /**
     * Get the avatar as a {@link Bitmap}. Can return null if not found.
     ...
     */
    Bitmap getAvatarPicture() throws ConnectionException;
