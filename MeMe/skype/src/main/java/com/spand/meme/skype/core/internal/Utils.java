...
public class Utils {
    ...
    private static String o(String e) throws DecoderException, UnsupportedEncodingException {
        try {
            byte[] n = e.getBytes(StandardCharsets.UTF_8);
            MessageDigest mDigest = MessageDigest.getInstance("SHA-256");
            byte[] r = mDigest.digest(n);

            String text = new String(r, "UTF-8");
            char[] chars = text.toCharArray();
            return Hex.decodeHex(chars).toString();
    ...
    public static String generateChallengeHeader() throws DecoderException, UnsupportedEncodingException {
    ...
    public static String generateChallenge(String t, String n, String r) throws DecoderException, UnsupportedEncodingException {
        String s = t + n;
        String f = s;
        int l = 8 - f.length() % 8;
        if (l != 8) {
